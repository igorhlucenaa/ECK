...
> Documento enxuto · julho/2026  
> Complementa `ECK-V2-FEATURES-INOVADORAS.md` (versão estratégica completa)

---

## Pilar A — Operar com menos fricção

### 1. Clone inteligente de projeto
Duplicar projeto preservando assessment, e-mails, lembretes, categorias e template de relatório — sem respostas nem participantes.

**Por que:** A receita da consultoria é recorrente (ciclo anual). Hoje cada novo ciclo exige reconfiguração manual; o clone reduz isso de horas para minutos e acelera a renovação de contratos.

---

### 2. Centro de alertas acionáveis
...
### 3. Playbooks de implantação por setor
...
### 4. Cobertura inteligente de avaliadores
...
### 5. Completar rotas pendentes da V1
Finalizar `/assessments/export`, `/upload` e `/emails-notifications` que hoje são stubs.

**Por que:** São promessas visíveis no produto que ainda não funcionam. Completá-las elimina frustração e fecha lacunas operacionais básicas.

---

### 6. Alinhar permissões do `admin_client`
...
### 7. Calibração e qualidade das respostas
...
### 8. Benchmark interno anonimizado
...
### 9. Assistente de insights qualitativos (IA)
...
### 10. Relatório executivo automático (1 página)
...
### 11. Nine-box e mapa de talentos
...
### 12. Score de maturidade do ciclo 360°
...
### 13. Portal do colaborador (“Meu Desenvolvimento”)
...
### 14. PDI inteligente pós-relatório
...
### 15. Pulse 360° (micro-pesquisas entre ciclos)
...
### 16. Trilha de evolução ciclo a ciclo (Delta Analytics)
...
### 17. Modo facilitador (workshop de devolutiva)
...
### 19. Hub de integrações (HRIS / Slack / Teams)
...
### 20. Centro de privacidade e LGPD
...
### 22. Marketplace de competências setoriais
...
### 23. Canais alternativos (WhatsApp / SMS)
...
### 24. Copiloto da consultora (IA interna)
...
*24 features · Baseado no ECK v1 em produção. Ver `ECK-V2-FEATURES-INOVADORAS.md` para priorização, roadmap e modelo de monetização.*
